import { RewardMaterialCategory } from "@/types";
 ...
 * Metal: 15 points/kg
 */
export const MATERIAL_RATES: Record<RewardMaterialCategory, { rate: number; label: string; co2Factor: number }> = {
 ...
 */
export function categorizeMaterial(material: string): RewardMaterialCategory {
